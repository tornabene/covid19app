...
import { PazienteComponent } from 'app/entities/paziente/paziente.component';
...
describe('Component Tests', () => {
  describe('Paziente Management Component', () => {
    let comp: PazienteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PazienteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pazientes && comp.pazientes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
